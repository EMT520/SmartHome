...
import com.briup.view.dao.Impl.UserDaoImpl;
...
public class LoginView {
    private String loginImage="image/login.png";
    private String backImage="image/background.jpg";
    private Dialog dig;
    public void init(){
        ...
        JLabel labelImage = new JLabel(new ImageIcon(loginImage));// 添加图片
        ...
        JLabel reportPane = new JLabel(new ImageIcon(backImage));// 添加图片
        ...
        ac.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                RegisterView registLayout = new RegisterView();
                f.dispose();
            }
        });
        /*
                ...
                try {
                    ...
                    if(user!=null) {
                        if(user.getPwd().equals(password.getText())) {
                            ...
                            MainView ml=new MainView();//为跳转的界面
                            f.dispose();
                        }else {
