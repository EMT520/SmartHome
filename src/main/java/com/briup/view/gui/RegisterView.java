...
public class RegisterView extends JFrame implements ActionListener{
    ...
    private JButton getCancel(){
        if (cancel == null){
            ...
            cancel.setBounds(160, 203, 81, 28);
    ...
    private JTextField getName_jf(){
        if (name_jf == null){
            ...
            name_jf.setText("");
            name_jf.setBounds(61, 10, 178, 22);
        }
        return name_jf;
    }
    //初始化滚动条
    private JScrollPane getJScrollPane0(){
        if (jScrollPane0 == null){
            ...
            jScrollPane0.setBounds(61, 103, 178, 80);
            //将滚动条添加到多行区域
    ...
    private JLabel getName_lab(){
        if (name_lab == null){
            name_lab = new JLabel();
            name_lab.setText("姓名");
            name_lab.setBounds(17, 11, 41, 18);
        }
        return name_lab;
    }
    public RegisterView(){
